...
test("self invoking functions", function() {
    ...
    (function(pv) {
        ...
        equal("string", typeof(publicValue), "is publicValue available in this context?"); // k.c. how can it access publicValue?
    })(publicValue);
...
test("arguments array", function() { // k.c. very useful
    var add = function() {
//        var total = 0;
//        for(var i = 0; i < arguments.length; i++) {
            // complete the implementation of this method so that it returns the sum of its arguments
            return Array.prototype.slice.call(arguments).reduce(function(cur, prev){return cur+prev;});
//        }
...
test("using call to invoke function",function(){
    ...
    equal('I am this!Where did it come from?', result, "what will the value of invokee's this be?"); // k.c. ??? wow.. it was correct.
});
