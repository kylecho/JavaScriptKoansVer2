...
test("array type", function() {
    equal('object', typeof([]), 'what is the type of an array?'); // k.c. typeof [] is 'object' not 'array'...
});
...
test("splice", function() {
    ...
    ok(daysOfWeek.equalTo(['Saturday', 'Sunday']), 'what is the value of daysOfWeek?'); // k.c. splice modifies the original array.
});
